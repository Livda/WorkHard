...
%bonhommes avec juste une seule classe qui est le systeme
\part{Domain Model}
\begin{center}
    \includegraphics[angle=90, height=21cm]{DomainModel.png}
\end{center}
\part{Sequence Diagram}
%classes qui interagissent entre elles
...
\includegraphics{../../../../Dropbox/sign.png}
\end{document}
